...
public class FindCommandParser implements Parser<FindCommand> {
    ...
    /**
     * Constructs a cumulative predicate that tests if a contact matches any of the search phrases provided
     * by the user.
     * <br>
     * Notably, tag search phrases are treated as exact matches, while prefixed search phrases are treated
     * as partial matches.
     * @param argMultimap
    ...
    /**
     * Checks that all search phrases are non-empty. Throws a ParseException if any of the search phrases is
     * empty or blank.
     *
     * @param argMultimap
    ...
    private void validateNonEmptyPhrases(ArgumentMultimap argMultimap) throws ParseException {
        ...
        boolean isAddressValid =
                argMultimap.getAllValues(PREFIX_ADDRESS).stream().allMatch(keyword -> !keyword.isBlank());
